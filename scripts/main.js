;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA CANTIK :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOONG KOK', 'PENCET LAGI', 'KU TAU DIRIMU MESTI SEBEL', 'TAPI IKI BENER ADA YANG ANEH', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET IKU', 'AYO DONG', 'IYA BENER IKI TERAKHIR KOK', 'YAUDAH DEHH', 'I', 'LOVE', 'YOU ♡', 'CINTA BANGET SAMA HESTI', 'BYE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SAKIT HATI HEHE :)']
